...
- Solution URL: [Add solution URL here](https://github.com/savaf/frontend_master_qr_code_component)
- Live Site URL: [Add live site URL here](https://savaf.github.io/frontend_master_qr_code_component/)
